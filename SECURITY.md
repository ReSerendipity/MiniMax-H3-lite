...
> ⚠️【已废弃 2026-09-15】本文件的现行版本已于 2026-09-11 移入 `.github/SECURITY_MATRIX.md`。本根目录副本仅为历史留存，**不再维护、请勿编辑**；漏洞上报与安全需求以 `.github/SECURITY.md` 与 `.github/SECURITY_MATRIX.md` 为准。
